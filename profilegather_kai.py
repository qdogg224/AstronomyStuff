...
outfile2="SNR0509_radius_distro_RP_CHRISTENE.txt"
...
print("Expansion is "+expo+" plus or minus "+uncert+" arcsec.")

f= open(outfile2, "w")

for i in range(len(expansion)):
	f.write("%.4f,%.4f,%.4f,%.4f" %(snr_phi[i],snr_rad1[i],snr_rad2[i],expansion[i])+"\n")
