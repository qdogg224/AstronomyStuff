...
#	xv1,yv1,num1=cgslice(ra1,dec1,regshape1,(i*360.0)/float(n),40,midfile1)
	xv1,yv1,num1=cgslice(ra1,dec1,regshape1,39.6,40,midfile1)
#	xv1=np.array(xv1)
#	yv1=np.array(yv1)
...
#	xv2,yv2,num2=cgslice(ra2,dec2,regshape2,(i*360.0)/float(n),40,midfile2)
	xv2,yv2,num2=cgslice(ra2,dec2,regshape2,39.6,40,midfile2)
#	xv2=np.array(xv2)
#	yv2=np.array(yv2)
...
uncert=np.sqrt((betterstdev*betterstdev+3*(0.492)*(0.492))/(3*np.float(n)))
